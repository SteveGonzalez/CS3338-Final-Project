...
\begin{tabular}{|c|c|c|}
    ...
    \hline
    12/04/2025 & Updated for snapshot 1 & 1.0 \\
    \hline
    12/06/2025 & Updated for snapshot 2 & 2.0 \\
    \hline
    12/08/2025 & Updated for snapshot 3 & 3.0 \\
    \hline
    12/10/2025 & Updated for snapshot 4 & 4.0 \\
    \hline
\end{tabular}
...
\begin{figure}[h!]
\centering 
\includegraphics[width=0.6\linewidth]{assets/SDD_Images/workflow.png}
\end{figure}
...
\begin{figure}[H]
\centering 
\includegraphics[width=0.5\linewidth]{assets/SDD_Images/MoonTrek-Directory.png}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\linewidth]{assets/SDD_Images/userinterface.png}
\end{figure}
